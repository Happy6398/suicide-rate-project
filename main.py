...
df = pd.read_csv(r"C:\Users\parja\Downloads\Death_rates_for_suicide__by_sex__race__Hispanic_origin__and_age__United_States.csv")
...
# 5->Recent Year Comparison (2018) - CORRECTED
...
plt.figure(figsize=(12, 8))
sns.barplot(data=recent_data, y='STUB_LABEL', x='ESTIMATE', hue='STUB_LABEL', palette='viridis', legend=False)
...
# 8->Boxplot of Suicide Rates by Demographic Groups - CORRECTED
...
plt.figure(figsize=(12, 6))
sns.boxplot(data=recent_years, y='STUB_LABEL', x='ESTIMATE', hue='STUB_LABEL', palette='Set2', legend=False)
